...
#include <values.h>
#include <istream>
#include <ostream>			// special values
...
//----------------------------------------------------------------------
//  Circular COS Distance Norm -- Shengqiao Li July 07, 2004 
//-------------------------------------------------------------------------
#ifdef COS_NORM
	#define DISTANCE 	"COS"
	
	#define ANN_POW(v)		(2*(1-cos(v)))
...
//----------------------------------------------------------------------
//  Circular ABS Distance Norm -- Shengqiao Li 5/19/2004-- slow
//  Circular COS Distance Norm -- Shengqiao Li July 08, 2004 change from DIFF to POW
...
//-------------------------------------------------------------------------
		...
		#define ANN_POW(v)		pow(M_PI-fabs(M_PI-fabs(v)), 2)
		#define ANN_ROOT(x)		sqrt(x)
		#define ANN_SUM(x,y)	((x) + (y))
		#define ANN_DIFF(x,y)	(y-x)
	#else
